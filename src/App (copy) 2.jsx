...
const App = () => {
  const [cars, updateCar] = useState([{model: "Outback", id: 1}])
  const [currentcar, updateCurrent] = useState([{model: "Outback", id: 1}])
  ...
  return (
    <div>
      ...
      {cars.map( car =>
          <Car model={car.model} id={car.id} handleClick={() => handleRemove(car.id)} />
      )
      }
